...
This provides the ability for automated (passwordless) logins using the SSH protocol.
...
If you use Poetry, a virtual environment will be created with the required dependency (Fabric).
- poetry install
...
- Install rsa public key for user tom onto server1,2,3 and 4
